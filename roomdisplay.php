...
$sql = "select room_no,seater,roomfee,std_allot from rooms"; 
...
?>   
<h1 style="font-family: 'Abhaya Libre', serif;" width="50%" border="1"><center>Room List</center></h1>  
...
$conn->close();?> 
    ...
    <center>
    <form action="updatede.php" method="POST">
    <input type="submit" name="edit" class="btn btn-success" value="EDIT ROOM DETAILS">
    </form></center>
